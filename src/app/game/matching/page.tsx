        ...
        <section className="relative isolate flex min-h-[100svh] items-center overflow-hidden bg-[#2f2118] px-6 py-24 pt-40 text-white">
          ...
          <div className="mx-auto max-w-6xl text-center">
            ...
            <div className="mt-9 flex flex-wrap justify-center gap-4">
              <span className="hero-stat-pill inline-flex h-11 items-center rounded-[10px] border border-white/18 bg-[#f5f0e9]/92 px-7 text-sm font-bold text-[#74481f] shadow-[0_14px_30px_rgb(19_12_8_/_0.18)] backdrop-blur-md">
